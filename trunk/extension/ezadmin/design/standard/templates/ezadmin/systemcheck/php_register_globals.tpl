<table width='100%'>
  	<tr>
  		...
  		{else}
  			{"eZ Publish will work with this option on however it will lead to some minor performance issues since all input variables will be made global on each script execution."|i18n( 'extension/admin' )}
  		{/if}
  		</td>
