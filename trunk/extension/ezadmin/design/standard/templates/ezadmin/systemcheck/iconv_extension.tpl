<table width='100%'>
  	<tr>
  		...
  		{if $result[2][persistent_data][result][value]}
  			{"The iconv extension is available to eZ Publish."|i18n( 'extension/admin' )}
  		{else}
  			{"The iconv extension is not available to eZ Publish. Without it eZ Publish will not work."|i18n( 'extension/admin' )}
  		{/if}
  		</td>
