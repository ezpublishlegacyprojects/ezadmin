<table width='100%'>
  	<tr>
  		...
  		{if $result[2][persistent_data][result]}
  			{"No problems were found with the memory limit."|i18n( 'extension/admin' )}
  		{else}
  			{"eZ Publish will not work correctly with a memory limit of"|i18n( 'extension/admin' )} {$result[2][current_memory]}.
  		{/if}
  		</td>
